<template>
    <div>
                    ...
                    <tbody v-if="resultData.data !=''">
                        <tr v-for="(value,index) in resultData.data">
                            ...
                            <td  class="width-200 text-center">
                                <a v-if="permissions.indexOf('balance.destroy') !=-1"  @click="deleteData(value.id)" class="btn btn-danger btn-sm"><i aria-hidden="true" class="fa fa-trash-o btnColor"></i></a>
                                <a v-if="permissions.indexOf('balance.edit') !=-1" @click="openUpdateModal(value.id)" class="btn btn-primary btn-sm"><i aria-hidden="true" class="fa fa-pencil-square-o btnColor"></i></a>
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        <ManageCredit :members="members"></ManageCredit>
    </div>
</template>
...
<script>
    ...
    import ManageCredit from './ManageCredit.vue';
    ...
    export default {
        ...
        methods: {
                index(pageNo,perPage){
                    ...
                    axios.get(base_url+"balance?page="+pageNo+"&perPage="+perPage).then((response) => {
                ...
                deleteData: function(id){
                    ...
                    swal({
                        ...
                        if (isConfirm) {
                            axios.delete(base_url+'balance/'+id).then((response) => {
                                _this.index(1);
