...
<script>
    ...
    export default {
        ...
        methods:{
            store:function(){
                axios.post(base_url+'mess-member', this.form).then( (response) => {
                    $('#addModel').modal('hide');
            ...
            update:function (id) {
                axios.put(base_url+'mess-member/'+id, this.form).then( (response) => {
        ...
        mounted(){
           ...
           $('#addModel,#editModel').on('hidden.bs.modal', function(){
            ...
            EventBus.$on('update-button-clicked', (id) => {
                ...
                axios.get(base_url+'mess-member/'+id+'/edit').then((response) => {
