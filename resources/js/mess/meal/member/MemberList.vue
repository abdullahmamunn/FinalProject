<template>
    <div>
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody v-if="resultData.data !=''">
                        <tr v-for="(value,index) in resultData.data">
                            ...
                            <td>{{  value.user_role ? value.user_role.role_name : ''    }}</td>
                            <td>
                            ...
                            <td  class="width-200 text-center">
                                <a v-if="permissions.indexOf('mess-member.destroy') !=-1"  @click="deleteData(value.id)" class="btn btn-danger btn-sm"><i aria-hidden="true" class="fa fa-trash-o btnColor"></i></a>
                                <a v-if="permissions.indexOf('mess-member.edit') !=-1" @click="openUpdateModal(value.id)" class="btn btn-primary btn-sm"><i aria-hidden="true" class="fa fa-pencil-square-o btnColor"></i></a>
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        <AddMember :role-list="roleList"></AddMember>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
                index(pageNo,perPage){
                    ...
                    axios.get(base_url+"mess-member?page="+pageNo+"&perPage="+perPage).then((response) => {
                ...
                deleteData: function(id){
                    ...
                    swal({
                        ...
                        if (isConfirm) {
                            axios.delete(base_url+'mess-member/'+id).then((response) => {
                                _this.index(1);
