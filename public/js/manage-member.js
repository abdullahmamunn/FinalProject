...
Vue.component('member-list', __webpack_require__(189));
...
Component.options.__file = "resources/js/mess/meal/member/MemberList.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-a748c6ac", Component.options)
  } else {
    hotAPI.reload("data-v-a748c6ac", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vue_assets__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__AddMember_vue__ = __webpack_require__(191);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Pagination_vue__ = __webpack_require__(164);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        index: function index(pageNo, perPage) {
            ...
            axios.get(base_url + "mess-member?page=" + pageNo + "&perPage=" + perPage).then(function (response) {
        ...
        deleteData: function deleteData(id) {
            ...
            swal({
                ...
                if (isConfirm) {
                    axios.delete(base_url + 'mess-member/' + id).then(function (response) {
                        _this.index(1);
...
Component.options.__file = "resources/js/mess/meal/member/AddMember.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-026c868e", Component.options)
  } else {
    hotAPI.reload("data-v-026c868e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        store: function store() {
            ...
            axios.post(base_url + 'mess-member', this.form).then(function (response) {
                $('#addModel').modal('hide');
        ...
        update: function update(id) {
            ...
            axios.put(base_url + 'mess-member/' + id, this.form).then(function (response) {
    ...
    mounted: function mounted() {
        ...
        __WEBPACK_IMPORTED_MODULE_0__vue_assets__["EventBus"].$on('update-button-clicked', function (id) {
            ...
            axios.get(base_url + 'mess-member/' + id + '/edit').then(function (response) {
              ...
              _c(
                "form",
                {
                  ...
                  on: {
                    submit: function($event) {
                      $event.preventDefault()
                      return _vm.update(_vm.form.role_id)
                    }
                  }
                },
                [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-026c868e", module.exports)
  }
}
...
var render = function() {
  ...
  return _c(
    ...
    [
                    ...
                    _vm._l(_vm.resultData.data, function(value, index) {
                      return _c("tr", [
                        ...
                        _c("td", [
                          _vm._v(
                            _vm._s(
                              value.user_role ? value.user_role.role_name : ""
                            )
                          )
                        ]),
                        _vm._v(" "),
                        ...
                        _c("td", { staticClass: "width-200 text-center" }, [
                          _vm.permissions.indexOf("mess-member.destroy") != -1
                            ? _c(
                                "a",
                                {
                            ...
                            : _vm._e(),
                          _vm._v(" "),
                          _vm.permissions.indexOf("mess-member.edit") != -1
                            ? _c(
                                "a",
                                {
      ...
      _vm._v(" "),
      _c("AddMember", { attrs: { "role-list": _vm.roleList } })
    ],
    1
  )
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-a748c6ac", module.exports)
  }
}
