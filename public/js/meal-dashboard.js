...
Vue.component('meal-dashboard', __webpack_require__(221));
...
Component.options.__file = "resources/js/mess/meal/dashboard/MealDashboard.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-ead3f5da", Component.options)
  } else {
    hotAPI.reload("data-v-ead3f5da", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Cards_vue__ = __webpack_require__(223);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Pagination_vue__ = __webpack_require__(164);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        ...
        Cards: __WEBPACK_IMPORTED_MODULE_0__Cards_vue___default.a
    },
    ...
    methods: {
        perDayTotal: function perDayTotal(date) {
            var total = 0;
        ...
        index: function index(pageNo, perPage) {
            ...
            axios.get(base_url + "mess-meal/overview?page=" + pageNo + "&perPage=" + perPage).then(function (response) {
                _this.head = response.data.head;
                _this.meals = response.data.meals;
                _this.footer = response.data.footer;
                _this.current_month = response.data.current_month;
                _this.cardData = response.data.card_data;
            });
        }
    },
...
Component.options.__file = "resources/js/mess/meal/dashboard/Cards.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-005bfb65", Component.options)
  } else {
    hotAPI.reload("data-v-005bfb65", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
      ...
      _c("div", { staticClass: "card" }, [
        _c("div", { staticClass: "card-content" }, [
          _c("div", { staticClass: "media align-items-stretch" }, [
            ...
            _c(
              "div",
              { staticClass: "p-2 bg-gradient-x-primary white media-body" },
              [
                _c("h5", [_vm._v("Total Meal")]),
                _vm._v(" "),
        ...
        _c("div", { staticClass: "card-content" }, [
          _c("div", { staticClass: "media align-items-stretch" }, [
            ...
            _c(
              ...
              { staticClass: "p-2 bg-gradient-x-primary white media-body" },
              [
                _c("h5", [_vm._v("Meal Rate")]),
                _vm._v(" "),
                _c("h5", { staticClass: "text-bold-400 mb-0" }, [
                  _vm._v(
                    " " +
                      _vm._s(
                        (_vm.data.total_market / _vm.data.total_meal).toFixed(2)
                      ) +
                      " "
                  )
                ])
      ...
      _c("div", { staticClass: "card" }, [
        _c("div", { staticClass: "card-content" }, [
          _c("div", { staticClass: "media align-items-stretch" }, [
            ...
            _c(
              "div",
              { staticClass: "p-2 bg-gradient-x-danger white media-body" },
              [
                _c("h5", [_vm._v("Members")]),
                _vm._v(" "),
                _c("h5", { staticClass: "text-bold-400 mb-0" }, [
                  _vm._v(_vm._s(_vm.data.total_members))
                ])
              ]
            )
          ])
      ...
      _c("div", { staticClass: "card" }, [
        _c("div", { staticClass: "card-content" }, [
          _c("div", { staticClass: "media align-items-stretch" }, [
            ...
            _c(
              "div",
              { staticClass: "p-2 bg-gradient-x-warning white media-body" },
              [
                _c("h5", [_vm._v("Balance")]),
                _vm._v(" "),
                _c("h5", { staticClass: "text-bold-400 mb-0" }, [
                  _vm._v(_vm._s(_vm.data.total_balance))
                ])
              ]
            )
          ])
      ...
      _c("div", { staticClass: "card" }, [
        _c("div", { staticClass: "card-content" }, [
          _c("div", { staticClass: "media align-items-stretch" }, [
            ...
            _c(
              "div",
              { staticClass: "p-2 bg-gradient-x-success white media-body" },
              [
                _c("h5", [_vm._v("Total Market")]),
                _vm._v(" "),
                _c("h5", { staticClass: "text-bold-400 mb-0" }, [
                  _vm._v(" " + _vm._s(_vm.data.total_market))
                ])
              ]
            )
          ])
              ...
              _c("div", { staticClass: "card-content" }, [
                  _c("div", { staticClass: "media align-items-stretch" }, [
                      ...
                      _c(
                          ...
                          { staticClass: "p-2 bg-gradient-x-primary white media-body" },
                          [
                              _c("h5", [_vm._v("New Balance")]),
                              _vm._v(" "),
                              _c("h5", { staticClass: "text-bold-400 mb-0" }, [
                                  _vm._v(
                                      " " +
                                      _vm._s(
                                          (_vm.data.total_balance - _vm.data.total_market)
                                      ) +
                                      " "
                                  )
                              ])
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      "div",
      { staticClass: "p-2 text-center bg-primary bg-darken-2" },
      [_c("i", { staticClass: "icon-camera font-large-2 white" })]
    )
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "p-2 text-center bg-danger bg-darken-2" }, [
      _c("i", { staticClass: "icon-user font-large-2 white" })
    ])
  },
  function() {
    var _vm = this
    ...
    return _c(
      "div",
      { staticClass: "p-2 text-center bg-warning bg-darken-2" },
      [_c("i", { staticClass: "icon-basket-loaded font-large-2 white" })]
    )
  },
  function() {
    var _vm = this
    ...
    return _c(
      "div",
      { staticClass: "p-2 text-center bg-success bg-darken-2" },
      [_c("i", { staticClass: "icon-wallet font-large-2 white" })]
    )
  }
]
render._withStripped = true
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-005bfb65", module.exports)
  }
}
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("Cards", { attrs: { data: _vm.cardData } }),
      _vm._v(" "),
      _c("div", { staticClass: "row" }, [
        _c("div", { staticClass: "col-xl-12 col-lg-12 col-12" }, [
          _c("div", { staticClass: "card" }, [
            _c("div", { staticClass: "card-content" }, [
              _c("h3", { staticStyle: { "text-align": "center" } }, [
                _vm._v(_vm._s(_vm.current_month))
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "table-responsive" }, [
                _c("table", { staticClass: "table table-bordered mb-0" }, [
                  ...
                  _c(
                    "tbody",
                    [
                      _vm._l(_vm.meals, function(date, index) {
                        return _c(
                          "tr",
                          [
                            _vm._l(date, function(item) {
                              return _c("td", [_vm._v(_vm._s(item))])
                            }),
                            _vm._v(" "),
                            _c("td", [_vm._v(_vm._s(_vm.perDayTotal(date)))])
                          ],
                          2
                        )
                      }),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-ead3f5da", module.exports)
  }
}
