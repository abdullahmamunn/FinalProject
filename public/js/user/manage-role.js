...
Vue.component('role-list', __webpack_require__(171));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__AddRole_vue__ = __webpack_require__(173);
                          ...
                          _vm.permissions.indexOf("role.destroy") != -1
                            ? _c(
                                "a",
                                {
                                  ...
                                  on: {
                                    click: function($event) {
                                      return _vm.deleteData(value.role_id)
                                    }
                                  }
                                },
                                [
                          ...
                          _vm.permissions.indexOf("role.edit") != -1
                            ? _c(
                                "a",
                                {
                                  ...
                                  on: {
                                    click: function($event) {
                                      return _vm.openUpdateModal(value.role_id)
                                    }
                                  }
                                },
                                [
