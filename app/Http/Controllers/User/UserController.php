...
class UserController extends Controller
{
    ...
    {
        $roleList = Role::where('role_name', UserRole::$MESS_ADMIN)
            ->orWhere('role_name', UserRole::$SUPER_ADMIN)
            ->get();
    ...
    public function store(Request $request)
    {
        ...
        $role = Role::where('role_name', UserRole::$MESS_ADMIN)->first();
        if ($role->role_id != $request->role_id) {
            dd('super admin can only create an mess admin');
        }
